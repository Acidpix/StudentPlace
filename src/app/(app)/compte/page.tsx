    ...
    <PageWidth>
      <div className="max-w-2xl space-y-8">
        ...
        <section className={`${CARD} p-4`}>
          <h2 className="eyebrow">Mes données</h2>
          ...
          {/* `buttonClasses` et non une chaîne recopiée : ce lien avait déjà
              divergé du bouton secondaire — mauvaise graisse, pas d'appui. */}
          <a
